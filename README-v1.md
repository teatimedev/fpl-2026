# Archived project overview — August 2026

This is the historical v1/preseason overview. Dates, prices, team selections,
counts and setup instructions below describe that period. For the current app,
v2 pipeline and operating instructions, start with [README.md](README.md).

...
Deadline **Sat 12 Sep, 12:30 UTC** — 1d 2h away.
Projections cover GW4–9.

## GW3 in review — what happened, and what it does and does not change

_400 players classified: 23 unavailable, 32 minutes loss, 39 minutes watch, 16 minutes gain, 13 role change, 57 variance, 220 on model. Retrospective classes graded: 2 weeks. A blank is printed with its xG; a haul with its xG; selection is a fact, finishing is a sample._
...
- lost their place — benched while healthy: Igor Jesus (NFO, 0.0 xG, 1 pts; GW4–9 14.7), Aaronson (LEE, 0.0 xG, 1 pts; GW4–9 14.6), Hume (SUN, 0.0 xG, 1 pts; GW4–9 13.8), Gusto (CHE, 0.0 xG, 1 pts; GW4–9 13.8), Bijol (LEE, 0.0 xG, 1 pts; GW4–9 13.7)
...
**Recommended: hold.** Sadiki → Groß, Foden → Barnes is the move queued — worth taking over the window, but taking it now rather than next week is worth only -0.2 (the plan scores 405.4 against 405.6 with this week held). You would have 4 free transfers next week.
...
**This Friday under uncertainty:** the planner's proposed GW4 squad beats holding in 58% of 4,000 simulations (average +1.1 points). The proposed change does not have a reliable points edge this week.
Best path from here: **405.4** pts (0 hits). Making no move this week and re-planning: 405.6. Acting now is worth **-0.2** across 2 moves — not enough; hold.

- **GW4** 64.1 pts, C Haaland, 3 FT  Sadiki → Groß, Foden → Barnes
- **GW5** 66.6 pts, C Haaland, 2 FT  hold
- **GW6** 67.5 pts, C Mbeumo, 3 FT  Milenković → Andersen
- **GW7** 69.4 pts, C Haaland, 3 FT  Raya → Tzolakis, Tarkowski → Ajayi, Groß → Palmer
...
| Wildcard | +8.5 over the window | — | Hold. Unlimited transfers now are worth 8.5 over the window. The squad is holding up (gap to the best possible XI 10.6–10.6 over the next weeks). |
...
|---|---|---|---|---|---|
| Samba £4.5 | +185400.0% | +1,854 | Millar £5.0 | -201100.0% | -2,011 |
| Vaz £5.0 | +184400.0% | +1,844 | Elliott £5.4 | -141100.0% | -1,411 |
| Ansah £5.0 | +161500.0% | +1,615 | Diarra £5.4 | -111200.0% | -1,112 |
| Flemming £5.5 | +128800.0% | +1,288 | Morato £5.0 | -90000.0% | -900 |
| Palacios £5.0 | +113000.0% | +1,130 | Humphreys £4.5 | -83000.0% | -830 |
| Timber £5.0 | +96500.0% | +965 | M.Sarr £4.5 | -80700.0% | -807 |

⭑ = in your squad.

**Price risk if you wait (shadow-only):**

- Target Barnes (net +86k this event) is at rise risk; waiting past the deadline could cost +0.1m [net +86k this event (in 116k / out 30k), sel 2.0% = Q1 (~77k to move), price 6.0 over 8 snaps (+0.0m in window)]
- Squad player Mbeumo (net -172k this event) at fall risk (-0.1m hurts the bank) [net -172k this event (in 94k / out 266k), sel 25.2% = Q3 (~150k to move), price 7.9 over 8 snaps (-0.1m in window), already -1x0.1m this event]
- Squad player Foden (net -110k this event) at fall risk (-0.1m hurts the bank) [net -110k this event (in 13k / out 123k), sel 4.6% = Q2 (~113k to move), price 7.0 over 8 snaps (+0.0m in window)]
- Squad player Thiago (net -181k this event) at fall risk (-0.1m hurts the bank) [net -181k this event (in 14k / out 195k), sel 11.7% = Q3 (~150k to move), price 7.9 over 8 snaps (-0.1m in window), already -1x0.1m this event]

_Based on 8 price snapshots. This warning is not part of the transfer verdict until at least six weeks of actual rises and falls can calibrate it._

---

_Generated 2026-09-11 10:03 UTC. Projections are estimates: hold-out rank correlation is about 0.46, so treat the ordering as a strong hint and the point totals as rough._

## Scouting

32 sourced observations; 8 API calls. Review these alongside the transfer stress tests in the app.
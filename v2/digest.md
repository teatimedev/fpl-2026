...
**Bench order:** Leno (4.2), Sadiki (2.8), O'Shea (2.8), Obi (0.6)
...
- **Bench order:** your first sub is Milenković (4.0); Sadiki (2.8) is the better first man off.
...
|---|---|---|---|---|---|---|
| Sadiki (SUN) | Gomez (BHA) | +0.0 | +1.2 | +2.7 | **+3.9** | +3.9 |
